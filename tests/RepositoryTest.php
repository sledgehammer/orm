...
class RepositoryTest extends DatabaseTestCase {
	...
	function test_getRepository_function() {
		...
		$this->expectError('Property: "superpowers" doesn\'t exist in a "SledgeHammer\Generated\Repository\Customer" object.',  'Show an notice when setting a non-existing property');
