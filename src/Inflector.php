...
class Inflector extends Object
{
     ...
     *                        'prefix' => Remove the given database/table prefix
    ...
    public static function modelize($name, $options = [])
    {
        ...
        if ($options['singularizeLast']) {
            $last = count($words) - 1;
            $words[$last] = self::singularize($words[$last]);
        }
     ...
     * @return string
     */
    public static function variablize($name)
    {
     ...
     */
    public static function camelCase($lowerCaseAndUnderscoredWord)
    {
     ...
     */
    public static function camelBack($lowerCaseAndUnderscoredWord)
    {
